...
namespace AtendimentoProntoSocorro
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Adicionando serviço session, que guarda em memória dados do Paciente, por exemplo, para navegação entre páginas 
            services.AddDistributedMemoryCache();
            services.AddSession();

            services.AddTransient<IPacienteRepository, PacienteRepository>();
            services.AddTransient<IFichaRepository, FichaRepository>();
            services.AddTransient<IDadosClinicosRepository, DadosClinicosRepository>();
        }
